# Generated by Django 4.2 on 2023-06-03 17:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('marca_prod', models.CharField(max_length=200)),
                ('cod_prod', models.CharField(max_length=200)),
                ('precio_prod', models.CharField(max_length=200)),
                ('desc_prod', models.CharField(max_length=200)),
            ],
            options={
                'verbose_name': 'Producto',
                'verbose_name_plural': 'Productos',
                'ordering': ['nom_prod', '-id'],
            },
        ),
        migrations.CreateModel(
            name='Usuario',
